...
class DragNDropSecondScreen extends StatefulWidget {
  int LevelID;
  int GameID;
  int gamescore;
  DragNDropSecondScreen({
    Key? key,
  ...
  _DragNDropSecondScreenState createState() => _DragNDropSecondScreenState();
}

class _DragNDropSecondScreenState extends State<DragNDropSecondScreen> {
        ...
        body: Container(
          ...
          child: Column(
            children: [
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return Row(
                                  children: [
                                    Spacer(),
                                    Column(
                                      children: state.dragGameList[0].index2
                                          .map((item) {
                                        test_list =
                                            state.dragGameList[0].index2;
                                        return Container(
                                    ...
                                    Spacer(flex: 2),
                                    Column(
                                      children: state.dragGameList[0].index2Copy
                                          .map((item) {
                                        test_list2 =
                                            state.dragGameList[0].index2Copy;
              ...
              if (widget.gamescore == 160) winnigGame(),
              //   Center(
              //     child: Column(
              //       children: [
              //         Padding(
  ...
  Widget winnigGame() {
    return Padding(
      ...
      child: AlertDialog(
        ...
        content: Text(
            ' You have completed this game and your total Score is : ${widget.gamescore}  ',
            style: GoogleFonts.quicksand(
            ...
            TextButton(
              ...
              onPressed: () {
                _sendScoreRepository.SendGamescoretoAPI(
                    widget.gamescore, widget.LevelID, widget.GameID);
                print('score + ${widget.gamescore}');
